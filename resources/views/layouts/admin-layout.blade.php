...
<meta name="keywords" content="infinity Tech World, a home of ICT and information technology.. learning both online and offline" />
             ...
             <!--header start here-->
				<div class="header-main">
					<div class="logo-w3-agile" style="background-color:white">
								<!-- <h1><a href="{{url('/admin')}}">Infinity tech</a></h1> -->
							</div>
					<div class="w3layouts-left" style="background-color:white">
					<div class="clearfix"> </div>
					</div>
					<div class="w3layouts-right" style="background-color:white">
					<div class="clearfix"> </div>
					</div>
										...
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">
												...
												<div class="user-name">
													...
													<span>{{ Auth::guard('admin')->user()->position }}</span>
												</div>
...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/admin')}}">Home</a> <i class="fa fa-angle-right"></i></li>
            </ol>
<!--four-grids here-->
	 <!--/content-inner-->
