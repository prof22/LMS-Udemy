<section class="menu-area">
    <div class="container-xl">
        <div class="row">
            <div class="col">
            {{-- <marquee><span style="color:gray"> N0 1 Dike Street Awka Anambra State ......  Admissions of students without regard to regionalism </span> </marquee> --}}
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                        <ul class="mobile-header-buttons">
                        <br><br>
                        <li><a class="mobile-nav-trigger" href="#mobile-primary-nav" style="padding-top:0px">Menu<span></span></a></li>
