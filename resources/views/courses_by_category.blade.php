                        ...
                        @foreach($offlinecourse as $course)
                                <li>
                                    <div class="course-box-2">
                                        ...
                                        <div class="course-details">
                                        <a href="{{ route('offline_detail', $course) }}" class="course-title">{{ $course->title }}</a>
                                           <a href="" class="course-instructor">
                                               <span class="instructor-name"> {{$course->instructor->last_name}} {{$course->instructor->first_name}}</span>
                                            </a>
                                            <div class="course-subtitle">
                                                {{ $course->short_description }}
                                            </div>
                                        ...
                                        <div class="course-price-rating">
                                            <div class="course-price">
                                            <span class="current-price">N{{ $course->amount }}</span>
                                                {{--<span class="original-price"></span>--}}
                                            </div>
                                            <div class="rating">
                                                <i class="fas fa-star filled"></i>
